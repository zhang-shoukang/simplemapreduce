...
public class DBTestMR extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        Job job = Job.getInstance(new Configuration(), this.getClass().getSimpleName() + new Date());
        ...
        org.apache.hadoop.mapreduce.lib.db.DBConfiguration.configureDB(job.getConfiguration(), "com.mysql.jdbc.Driver", "jdbc:mysql://localhost:3306/mapreduce",
                "root", "root");
